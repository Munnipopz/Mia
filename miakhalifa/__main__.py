...
from miakhalifa import dispatcher, updater, TOKEN, WEBHOOK, SUDO_USERS, OWNER_ID, CERT_PATH, PORT, URL, LOGGER, OWNER_NAME, ALLOW_EXCL
from miakhalifa.modules import ALL_MODULES
from miakhalifa.modules.helper_funcs.chat_status import is_user_admin
from miakhalifa.modules.helper_funcs.misc import paginate_modules
from miakhalifa.modules.connection import connected
from miakhalifa.modules.connection import connect_button
...
SOURCE_STRING = """
⚡I'm built in python3, using the python-telegram-bot library, and am fully opensource - you can find what makes me tick [here](https://t.me/Munnipopz)
⚡You Can Clone Me [Here](https://t.me/Munnipopz)
"""
...
if START_IMG is None:
    img = "https://telegra.ph/file/0dc70b32547fd55f960e2.jpg"
else:
  img = START_IMG    
...
def get_help(bot: Bot, update: Update):
    ...
    if chat.type != chat.PRIVATE:
        update.effective_message.reply_text("Contact me in PM to get the list of possible commands.",
                                            reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="⚜️Help",url="t.me/{}?start=help".format(bot.username))]])
...
def main():
    ...
    if WEBHOOK:
        ...
        LOGGER.info("miakhalifa running...")
